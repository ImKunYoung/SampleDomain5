...
export class Config {
  debugLogging = 'debug';
  'server.port' = '8081';
  'jhipster.clientApp.name' = 'SampleDomain5';
  ...
  'jhipster.mail.from' = 'SampleDomain5@localhost';
  'jhipster.swagger.default-include-pattern' = '/api/.*';
  'jhipster.swagger.title' = 'SampleDomain5 API';
  'jhipster.swagger.description' = 'SampleDomain5 API documentation';
  ...
  'eureka.instance.appname' = 'SampleDomain5';
  'eureka.instance.instanceId' = 'SampleDomain5:${random.value}';
  ...
  'cloud.config.name' = 'SampleDomain5';
