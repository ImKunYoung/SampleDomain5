...
describe('Location Controller', () => {
    ...
    it('/GET all locations ', async () => {
        ...
        const getEntities: LocationDTO[] = (await request(app.getHttpServer())
        .get('/api/locations')
        .expect(200)).body;
    ...
    it('/GET locations by id', async () => {
        ...
        const getEntity: LocationDTO = (await request(app.getHttpServer())
    ...
    it('/POST create locations', async () => {
        ...
        const createdEntity: LocationDTO = (await request(app.getHttpServer())
            .post('/api/locations')
            .send(entityMock)
            .expect(201)).body;
    ...
    it('/PUT update locations', async () => {
        ...
        const updatedEntity: LocationDTO = (await request(app.getHttpServer())
            .put('/api/locations')
            .send(entityMock)
            .expect(201)).body;
    ...
    it('/DELETE locations', async () => {
        ...
        const deletedEntity: LocationDTO = (await request(app.getHttpServer())
