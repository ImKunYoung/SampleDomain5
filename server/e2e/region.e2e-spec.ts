...
describe('Region Controller', () => {
    ...
    it('/GET all regions ', async () => {
        ...
        const getEntities: RegionDTO[] = (await request(app.getHttpServer())
        .get('/api/regions')
        .expect(200)).body;
    ...
    it('/GET regions by id', async () => {
        ...
        const getEntity: RegionDTO = (await request(app.getHttpServer())
    ...
    it('/POST create regions', async () => {
        ...
        const createdEntity: RegionDTO = (await request(app.getHttpServer())
            .post('/api/regions')
            .send(entityMock)
            .expect(201)).body;
    ...
    it('/PUT update regions', async () => {
        ...
        const updatedEntity: RegionDTO = (await request(app.getHttpServer())
            .put('/api/regions')
            .send(entityMock)
            .expect(201)).body;
    ...
    it('/DELETE regions', async () => {
        ...
        const deletedEntity: RegionDTO = (await request(app.getHttpServer())
