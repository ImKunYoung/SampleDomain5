...
describe('Employee Controller', () => {
    ...
    it('/GET all employees ', async () => {
        ...
        const getEntities: EmployeeDTO[] = (await request(app.getHttpServer())
        .get('/api/employees')
        .expect(200)).body;
    ...
    it('/GET employees by id', async () => {
        ...
        const getEntity: EmployeeDTO = (await request(app.getHttpServer())
    ...
    it('/POST create employees', async () => {
        ...
        const createdEntity: EmployeeDTO = (await request(app.getHttpServer())
            .post('/api/employees')
            .send(entityMock)
            .expect(201)).body;
    ...
    it('/PUT update employees', async () => {
        ...
        const updatedEntity: EmployeeDTO = (await request(app.getHttpServer())
            .put('/api/employees')
            .send(entityMock)
            .expect(201)).body;
    ...
    it('/DELETE employees', async () => {
        ...
        const deletedEntity: EmployeeDTO = (await request(app.getHttpServer())
