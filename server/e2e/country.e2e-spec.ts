...
describe('Country Controller', () => {
    ...
    it('/GET all countries ', async () => {
        ...
        const getEntities: CountryDTO[] = (await request(app.getHttpServer())
        .get('/api/countries')
        .expect(200)).body;
    ...
    it('/GET countries by id', async () => {
        ...
        const getEntity: CountryDTO = (await request(app.getHttpServer())
    ...
    it('/POST create countries', async () => {
        ...
        const createdEntity: CountryDTO = (await request(app.getHttpServer())
            .post('/api/countries')
            .send(entityMock)
            .expect(201)).body;
    ...
    it('/PUT update countries', async () => {
        ...
        const updatedEntity: CountryDTO = (await request(app.getHttpServer())
            .put('/api/countries')
            .send(entityMock)
            .expect(201)).body;
    ...
    it('/DELETE countries', async () => {
        ...
        const deletedEntity: CountryDTO = (await request(app.getHttpServer())
