...
describe('Job Controller', () => {
    ...
    it('/GET all jobs ', async () => {
        ...
        const getEntities: JobDTO[] = (await request(app.getHttpServer())
        .get('/api/jobs')
        .expect(200)).body;
    ...
    it('/GET jobs by id', async () => {
        ...
        const getEntity: JobDTO = (await request(app.getHttpServer())
    ...
    it('/POST create jobs', async () => {
        ...
        const createdEntity: JobDTO = (await request(app.getHttpServer())
            .post('/api/jobs')
            .send(entityMock)
            .expect(201)).body;
    ...
    it('/PUT update jobs', async () => {
        ...
        const updatedEntity: JobDTO = (await request(app.getHttpServer())
            .put('/api/jobs')
            .send(entityMock)
            .expect(201)).body;
    ...
    it('/DELETE jobs', async () => {
        ...
        const deletedEntity: JobDTO = (await request(app.getHttpServer())
