...
describe('JobHistory Controller', () => {
    ...
    it('/GET all job-histories ', async () => {
        ...
        const getEntities: JobHistoryDTO[] = (await request(app.getHttpServer())
    ...
    it('/GET job-histories by id', async () => {
        ...
        const getEntity: JobHistoryDTO = (await request(app.getHttpServer())
    ...
    it('/POST create job-histories', async () => {
        ...
        const createdEntity: JobHistoryDTO = (await request(app.getHttpServer())
    ...
    it('/PUT update job-histories', async () => {
        ...
        const updatedEntity: JobHistoryDTO = (await request(app.getHttpServer())
    ...
    it('/DELETE job-histories', async () => {
        ...
        const deletedEntity: JobHistoryDTO = (await request(app.getHttpServer())
